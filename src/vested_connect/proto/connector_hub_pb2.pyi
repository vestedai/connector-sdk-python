...
class ConnectorMsg(_message.Message):
    __slots__ = ("hello", "register", "tool_call_response", "heartbeat")
    ...
    heartbeat: Heartbeat
    def __init__(self, hello: _Optional[_Union[Hello, _Mapping]] = ..., register: _Optional[_Union[Register, _Mapping]] = ..., tool_call_response: _Optional[_Union[ToolCallResponse, _Mapping]] = ..., heartbeat: _Optional[_Union[Heartbeat, _Mapping]] = ...) -> None: ...
...
class Register(_message.Message):
    __slots__ = ("baseline_fingerprint", "agents")
    BASELINE_FINGERPRINT_FIELD_NUMBER: _ClassVar[int]
    AGENTS_FIELD_NUMBER: _ClassVar[int]
    baseline_fingerprint: str
    agents: _containers.RepeatedCompositeFieldContainer[AgentDecl]
    def __init__(self, baseline_fingerprint: _Optional[str] = ..., agents: _Optional[_Iterable[_Union[AgentDecl, _Mapping]]] = ...) -> None: ...
...
class ToolCallResponse(_message.Message):
    ...
    error: str
    duration_ms: int
    def __init__(self, invocation_id: _Optional[str] = ..., result_json: _Optional[bytes] = ..., error: _Optional[str] = ..., duration_ms: _Optional[int] = ...) -> None: ...
...
class HubMsg(_message.Message):
    __slots__ = ("hello_ack", "register_ack", "tool_call_request", "heartbeat_ack", "go_away")
    ...
    go_away: GoAway
    def __init__(self, hello_ack: _Optional[_Union[HelloAck, _Mapping]] = ..., register_ack: _Optional[_Union[RegisterAck, _Mapping]] = ..., tool_call_request: _Optional[_Union[ToolCallRequest, _Mapping]] = ..., heartbeat_ack: _Optional[_Union[HeartbeatAck, _Mapping]] = ..., go_away: _Optional[_Union[GoAway, _Mapping]] = ...) -> None: ...
